...
const initialState = {
    loading : false,
    addTask : false,
    TodoList : [{Title:"Say Hello to the World",Descript:"4",Status:"High",id:Math.floor(Math.random()*10000000),isEdit:false}], //bejay inke baray isEdit yek state joda tarif konim onn ro dar inja tarif mikonim
    CompletedTasks:[],                                                                                                                                
};
